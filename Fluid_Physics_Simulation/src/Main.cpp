...
static const char  *APP_VERSION  = "Version 1.7";
...
"-h              Specify grid height (rows). (DEFAULT 20 rows.)\n"
"-height         Alias for -h.\n"
...
"-render #       Don't render until specified frame number. -1 is never render. (DEFAULT is 0).\n"
...
"-w              Specify grid width (columns). (DEFAULT 25 columns.)\n"
"-width          Alias for -w.\n"
    ;
#if USE_CPP_IOSTREAM
    std::cout << HELP;
